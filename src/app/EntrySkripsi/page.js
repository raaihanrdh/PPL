    ...
    <div className="flex">
      ...
      <main className="flex-1 h-screen bg-gray-300 mt-10 p-10">
          <div className="mt-10 container mx-auto">
            <h1 className="text-4xl flex flex-none font-semibold   dark:text-black mt-10" >Entry Skripsi</h1>
                  ...
                  <div className="w-full h-full">
                    <div className="mb-4">
                      ...
                      <div className="input-box">
                        <input type="text" id="nilaiskripsi" placeholder="Nilai Skripsi" className="input input-bordered w-full" />
                      </div>
                    </div>
                    <div className="mb-4">
                      ...
                      <div className="input-box">
                        <input type="text" id="jadwalsidang" placeholder="Jadwal Sidang" className="input input-bordered w-full" />
                      </div>
                    </div>
