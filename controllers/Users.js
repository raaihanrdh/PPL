...
export const createUser = async (req, res) => {
  ...
  try {
    console.log(nama, email, hashPassword, role,);
    await User.create({
      nama: nama,
      email: email,
...
export const updateUser = async (req, res) => {
  ...
  const { nama, email, role } = req.body; // Mendapatkan data yang akan diupdate dari body request
  ...
  try {
    ...
    user.nama = nama || user.nama; // Jika name tidak disediakan, gunakan nilai yang ada
